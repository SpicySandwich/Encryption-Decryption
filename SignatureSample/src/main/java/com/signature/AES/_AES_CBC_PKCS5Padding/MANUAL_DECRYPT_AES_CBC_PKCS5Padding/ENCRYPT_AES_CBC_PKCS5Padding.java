...
@Slf4j
public class ENCRYPT_AES_CBC_PKCS5Padding {
    ...
    public String encrypt(String message){
        ...
        try {
            byte[] bytesIV = Base64.getDecoder().decode(enCodeIV());
    ...
    public static void main(String[] args) {
        ENCRYPT_AES_CBC_PKCS5Padding ts = new ENCRYPT_AES_CBC_PKCS5Padding();
